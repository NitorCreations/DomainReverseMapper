...
public class DomainMapperFactory {
    ...
    public DomainMapper create(final List<String> packages, final URLClassLoader classLoader) throws ClassNotFoundException {
    ...
    public DomainMapper create(final List<String> packages) throws ClassNotFoundException {
